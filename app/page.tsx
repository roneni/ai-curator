...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-purple-500 overflow-x-hidden" dir="rtl">
      ...
      <div className="bg-gray-900/30 p-12 rounded-[60px] border border-gray-800 space-y-12 backdrop-blur-sm mt-20 animate-in slide-in-from-bottom duration-1000 delay-300">
        <header className="space-y-4">
          <h3 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-emerald-400 uppercase tracking-tighter">ERRC Framework</h3>
          <p className="text-gray-500 font-light text-xl">The "Blue Ocean" logic that separates us from the Red Ocean competition.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* CREATE */}
          <div className="bg-gray-950/50 p-8 rounded-[40px] border border-blue-900/20 hover:border-blue-500/30 transition group relative overflow-hidden">
